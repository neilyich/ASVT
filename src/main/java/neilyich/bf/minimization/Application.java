...
public class Application {
    ...
    private static boolean test(String vector) {
        ...
        System.out.println("\n\n\n----------------\n\n");
        System.out.println("Quine McCluskey algorithm    : " + f1.toString() + " ; weight = " + f1.weight());
        System.out.println("Undetermined coefs algorithm : " + f2.toString() + " ; weight = " + f2.weight());
        System.out.println();
        var dif1 = f1.diff(f2);
        var dif2 = f2.diff(f1);
...
// 1000100000100111111011101110011101010000000001010111111001010101
